...
export interface KeysPersistence {
    ...
    create(correlationId: string, item: KeyV1, callback: (err: any, item: KeyV1) => void): void;
    update(correlationId: string, item: KeyV1, callback: (err: any, item: KeyV1) => void): void;
    deleteById(correlationId: string, id: string, callback: (err: any, item: KeyV1) => void): void;
}
