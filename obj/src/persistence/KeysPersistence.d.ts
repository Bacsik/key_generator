...
export interface KeysPersistence {
    ...
    nextKey(correlationId: string, key: string, number: number, callback: (err: any, key: KeyV1) => void): void;
    createKey(correlationId: string, key: string, callback: (err: any, item: KeyV1) => void): void;
    resetKey(correlationId: string, key: string, callback: (err: any, item: KeyV1) => void): void;
    deleteById(correlationId: string, key: string, callback: (err: any, item: KeyV1) => void): void;
}
